...
public static partial class Detour{
    ...
    */
							      ...
							      ref int segMin, ref int segMax)
    {
	    ...
	    dtVsub(ref dir, p1, p0);
	
	    for (int i = 0, j = nverts-1; i < nverts; j=i++)
	    {
		    float[] edge = new float[3];
            float[] diff = new float[3];
		    dtVsub(ref edge, 0, verts,i*3, verts,j*3);
		    dtVsub(ref diff, 0, p0,0, verts,j*3);
    ...
    public static void dtCalcPolyCenter(ref float[] tc, ushort[] idx, int nidx, float[] verts)
    {
	    tc[0] = 0.0f;
	    tc[1] = 0.0f;
	    tc[2] = 0.0f;
    ...
    public static bool dtClosestHeightPointTriangle(float [] p, int pStart, float[] a, int aStart, float[] b, int bStart, float[] c, int cStart, ref float h)
    {
	    ...
	    dtVsub(ref v0, 0, c,cStart,a,aStart);
	    dtVsub(ref v1, 0, b,bStart,a,aStart);
	    dtVsub(ref v2, 0, p,pStart,a,aStart);
    ...
    public static bool dtIntersectSegSeg2D(float[] ap, int apStart, float[] aq, int aqStart,
        ...
        float[] v = new float[3];
        float[] w = new float[3];
        dtVsub(ref u, 0, aq, aqStart, ap, apStart);
        dtVsub(ref v, 0, bq, bqStart, bp, bpStart);
        dtVsub(ref w, 0, ap, apStart, bp, bpStart);
        float d = vperpXZ(u, v);
        if (Math.Abs(d) < 1e-6f) return false;
        s = vperpXZ(v, w) / d;
        t = vperpXZ(u, w) / d;
    ...
    public static void dtVcross(ref float[] dest, float[] v1, float[] v2) {
    ...
    public static void dtVmad(ref float[] dest, float[] v1, float[] v2, float s) {
        dest[0] = v1[0] + v2[0] * s;
        dest[1] = v1[1] + v2[1] * s;
        dest[2] = v1[2] + v2[2] * s;
    }
    ...
    public static void dtVlerp(ref float[] dest, float[] v1, float[] v2, float t) {
        dest[0] = v1[0] + (v2[0] - v1[0]) * t;
        dest[1] = v1[1] + (v2[1] - v1[1]) * t;
        dest[2] = v1[2] + (v2[2] - v1[2]) * t;
    }
    public static void dtVlerp(ref float[] dest, int destStart, float[] v1, int v1Start, float[] v2, int v2Start, float t) {
    ...
    public static void dtVadd(ref float[] dest, float[] v1, float[] v2) {
        dest[0] = v1[0] + v2[0];
        dest[1] = v1[1] + v2[1];
        dest[2] = v1[2] + v2[2];
    }
    public static void dtVadd(ref float[] dest, int destStart, float[] v1, int v1Start, float[] v2, int v2Start) {
    ...
    public static void dtVsub(ref float[] dest, float[] v1, float[] v2) {
        dest[0] = v1[0] - v2[0];
        dest[1] = v1[1] - v2[1];
        dest[2] = v1[2] - v2[2];
    }
    public static void dtVsub(ref float[] dest, int destStart, float[] v1, int v1Start, float[] v2, int v2Start) {
        dest[destStart + 0] = v1[v1Start + 0] - v2[v2Start + 0];
        dest[destStart + 1] = v1[v1Start + 1] - v2[v2Start + 1];
        dest[destStart + 2] = v1[v1Start + 2] - v2[v2Start + 2];
    }
    ...
    public static void dtVscale(ref float[] dest, float[] v, float t) {
        dest[0] = v[0] * t;
        dest[1] = v[1] * t;
        dest[2] = v[2] * t;
    }
    public static void dtVscale(ref float[] dest, int destStart, float[] v, int vStart, float t) {
    ...
    public static void dtVmin(ref float[] mn, float[] v) {
        mn[0] = Math.Min(mn[0], v[0]);
        mn[1] = Math.Min(mn[1], v[1]);
        mn[2] = Math.Min(mn[2], v[2]);
    }
    public static void dtVmin(ref float[] mn, int mnStart, float[] v, int vStart) {
    ...
    ///  @param[in]		v	A vector. [(x, y, z)]
    public static void dtVmax(ref float[] mx, float[] v) {
        mx[0] = Math.Max(mx[0], v[0]);
        mx[1] = Math.Max(mx[1], v[1]);
        mx[2] = Math.Max(mx[2], v[2]);
    }
    public static void dtVmax(ref float[] mx, int mxStart, float[] v, int vStart) {
    ...
    public static void dtVset(ref float[] dest, float x, float y, float z) {
        dest[0] = x; dest[1] = y; dest[2] = z;
    }
    public static void dtVset(ref float[] dest, int destStart, float x, float y, float z) {
    ...
    public static void dtVcopy(ref float[] dest, float[] a) {
        dest[0] = a[0];
        dest[1] = a[1];
        dest[2] = a[2];
    }
    public static void dtVcopy(ref float[] dest, int destStart, float[] a, int aStart) {
